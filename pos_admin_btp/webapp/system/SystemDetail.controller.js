sap.ui.define([
	...
	BaseController, JSONModel, URLConstants, ErrorMessage, Formatter, Filter, FilterOperator, MessageBox, MessageToast
) {
	"use strict";
	...
	return BaseController.extend("com.posadminbtp.system.SystemDetail", {
		...
		onPressSave() {
			...
			if (valid.length == 0) {
				MessageBox.success(this.getResourceProperty("msg_update"), {
					onClose: function () {
						this.onPressCancel();
					}.bind(this)
				});
